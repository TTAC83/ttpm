-- BAU Weekly Review System Migration (Fixed policies)
...
DROP POLICY IF EXISTS read_uploads ON bau_weekly_uploads;
DROP POLICY IF EXISTS read_metrics ON bau_weekly_metrics;
DROP POLICY IF EXISTS read_reviews ON bau_weekly_reviews;
DROP POLICY IF EXISTS read_aliases ON bau_customer_aliases;
DROP POLICY IF EXISTS read_catalog ON bau_metric_catalog;
DROP POLICY IF EXISTS write_metrics_internal ON bau_weekly_metrics;
DROP POLICY IF EXISTS write_reviews_internal ON bau_weekly_reviews;
DROP POLICY IF EXISTS write_uploads_internal ON bau_weekly_uploads;
DROP POLICY IF EXISTS write_aliases_internal ON bau_customer_aliases;
DROP POLICY IF EXISTS write_catalog_internal ON bau_metric_catalog;
...
DROP POLICY IF EXISTS storage_bau_weekly_read ON storage.objects;
DROP POLICY IF EXISTS storage_bau_weekly_write ON storage.objects;
DROP POLICY IF EXISTS storage_bau_weekly_update ON storage.objects;
