...
CREATE TABLE public.solutions_projects (
  ...
  domain USER_DEFINED NOT NULL, -- using existing domain enum
  site_name TEXT NOT NULL,
  site_address TEXT,
  salesperson UUID REFERENCES auth.users(id),
  solutions_consultant UUID REFERENCES auth.users(id),
  customer_lead UUID REFERENCES auth.users(id),
