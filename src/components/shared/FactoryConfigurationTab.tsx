...
interface FactoryConfigurationTabProps {
  projectId: string;
...
export const FactoryConfigurationTab = ({ projectId, type, projectDomain = '', onUpdate }: FactoryConfigurationTabProps) => {
  ...
  const fetchFactoryData = async () => {
    try {
      ...
      toast({
        title: 'Error',
        description: 'Failed to fetch factory configuration',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: 'Factory configuration saved successfully',
      });
      setIsEditing(false);
      fetchFactoryData();
      ...
      toast({
        title: 'Error',
        description: 'Failed to save factory configuration',
        variant: 'destructive',
      });
    } finally {
      setSaving(false);
