...
export default function ScheduleRequired() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-muted-foreground">Loading schedule required models...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Models Requiring Schedule</CardTitle>
        </CardHeader>
                ...
                {filteredAndSortedModels.length === 0 ? (
                  ...
                  filteredAndSortedModels.map((model) => (
                    <TableRow key={model.id}>
                      ...
                      <TableCell>
                        {model.product_run_start ? formatDateUK(model.product_run_start) : 
                          <span className="text-destructive font-medium">Not set</span>
                        }
                      </TableCell>
                      <TableCell>
                        {model.product_run_end ? formatDateUK(model.product_run_end) : 
                          <span className="text-destructive font-medium">Not set</span>
                        }
                      </TableCell>
