...
export function AttributeDialog({
  ...
  const showRange = formData.validation_type === "range";
  const showMinMaxDate = config?.showMinMaxDate && formData.apply_min_max_date;
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {showMinMaxDate && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="attr-min-date">Min Date</Label>
                  <Input
                    id="attr-min-date"
                    type="date"
                    value={formData.min_value}
                ...
                <div>
                  <Label htmlFor="attr-max-date">Max Date</Label>
                  <Input
                    id="attr-max-date"
                    type="date"
                    value={formData.max_value}
            ...
            <div className="max-w-xs">
              ...
              <Input
                ...
                placeholder="Pre-filled when added to a project"
              />
            </div>
          </div>
        </div>
