  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-muted-foreground">Loading footage required models...</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">
          Footage Required <span className="text-muted-foreground">({models.length})</span>
        </h1>
        <p className="text-muted-foreground mt-2">
          Vision models with status "Footage Required" that have production run dates set
        </p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Models Ready for Footage</CardTitle>
        </CardHeader>
                ...
                {filteredAndSortedModels.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={11} className="text-center text-muted-foreground py-8">
                      No models found ready for footage
                    </TableCell>
                  </TableRow>
                ) : (
