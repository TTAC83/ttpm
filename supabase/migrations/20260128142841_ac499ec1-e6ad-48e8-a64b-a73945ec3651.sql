-- Add camera_ip column to cameras table
ALTER TABLE public.cameras ADD COLUMN IF NOT EXISTS camera_ip text;

-- Update the get_line_full_data function to include camera_ip
