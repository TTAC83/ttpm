  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-muted-foreground">Loading validation required models...</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">
          Validation Required <span className="text-muted-foreground">({models.length})</span>
        </h1>
        <p className="text-muted-foreground mt-2">
          Vision models requiring validation
        </p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Models Requiring Validation</CardTitle>
        </CardHeader>
                ...
                {filteredAndSortedModels.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={9} className="text-center text-muted-foreground py-8">
                      No models requiring validation
                    </TableCell>
                  </TableRow>
                ) : (
